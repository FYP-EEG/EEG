...
font = pygame.font.Font("fontawesome-solid-900.otf", 64) #fontawesome load
inventory = Button(0, "inventory", size, (0, center_y+50), os.path.join(path, "hand-fist-solid.png"))
